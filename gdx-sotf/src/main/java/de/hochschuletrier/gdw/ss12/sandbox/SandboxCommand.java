...
public class SandboxCommand {
    ...
    public static void init(AssetManagerX assetManager) {
        ...
        try {
            for (Class clazz : ClassUtils.findClassesInPackage("de.hochschuletrier.gdw.ss12.sandbox")) {
